...
namespace QueryMultiDb.Tests.System
{
    public class DatabaseFixture : IDisposable
    {
        ...
        public static string IntegratedSecurityConnectionString => IsAppVeyor
            ? @"Data Source=.\SQL2017;Initial Catalog=tempdb;Integrated Security=True;Pooling=False;Connect Timeout=5;Network Library=dbmssocn;Application Name=QueryMultiDb;Workstation ID=APPVEYOR-VM;ApplicationIntent=ReadWrite"
